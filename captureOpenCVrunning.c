...
#define WHITEY 200//흰색 threshhold
...
#define INRANGEMAXY 100// rotary 출발여부 판단부 roi 이 범위안에 차체 들어오면 긍정적
#define INRANGEMINY 0
#define INRANGEMAXX 200
#define INRANGEMINX 0

#define OUTRANGEMAXY 240 //rotary 출발여부 판단부 roi 이 범위 안에 차체 들어오면 위험
#define OUTRANGEMINY 100
#define OUTRANGEMAXX 320
#define OUTRANGEMINX 100


#define SHADOWYMAX 81 //로터리 주행시 그림자 threshold
...
#define RUNNING_RANGE_MIN_X 0//로터리 주행시 차체 확인 ROI
#define RUNNING_RANGE_MAX_X 80
#define RUNNING_RANGE_MIN_Y 100
#define RUNNING_RANGE_MAX_Y 200

#define SHADOW_RANGE_MIN_X 10 //로터리 주행시 그림자 확인 ROI
